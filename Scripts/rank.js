...
N.observe('numericValue', function() {
  if (N.numericValue !== undefined) {
    document.getElementById("result").innerHTML = "Top " + (100*N.numericValue).toFixed(1) + "%";
    document.getElementById("rankNumber").innerHTML = "Equivalent rank (Class of 2026): Top " + (524*N.numericValue).toFixed(0);
  }
});
